...
export default function ExtractContracogsPdfPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${apiUrl}/api/extract-contracogs-pdf/upload`, {
        method: "POST",
        body: formData,
      });
      ...
      a.href = url;
      a.download = "extracted_contracogs.csv";
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-800 tracking-tight">Extract ContraCoGS PDF Content</h1>
        <p className="text-slate-500 mt-2">Upload a ZIP file containing ContraCoGS invoice PDFs to extract line-item data into a CSV.</p>
      </div>
